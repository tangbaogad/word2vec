...
import os
import gensim
# from easyword2vec import model_train
# from easyprocess import cut_txt
...
cut_txt('衣服.txt')  # 须注意文件必须先另存为utf-8编码格式

save_model_name = '衣服.model'
...
# 计算两个词的相似度/相关程度
y1 = model_1.similarity("价格", "性价比")
print(u"价格和性价比相似度为：", y1)
print("-------------------------------\n")

# 计算某个词的相关词列表
y2 = model_1.most_similar("面料", topn=10)  # 10个最相关的
print(u"和面料最相关的词有：\n")
for item in y2:
    print(item[0], item[1])
print("-------------------------------\n")
